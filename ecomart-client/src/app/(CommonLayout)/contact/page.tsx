  ...
  return (
    <div>
      ...
      <div className="max-w-7xl grid grid-cols-1 md:grid-cols-2 w-full px-4 md:px-0 mx-auto gap-10 md:gap-32 min-h-screen justify-center items-center">
        <div>
          <h2 className="text-2xl md:text-3xl font-semibold uppercase pt-4 md:pt-0">
            Contact Us
          </h2>
          <p className="pt-6 pb-12 text-sm md:text-base text-muted-foreground">
          ...
          <div className="grid grid-cols-1 gap-10 text-muted-foreground">
